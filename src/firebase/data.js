export function seedDatabase(firebase) {
  function getUUID() {
    ...
    /* eslint-disable */
    return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, (c) => { // находит и заменяет все ху
      const piece = (Math.random() * 16) | 0; // отбрасывает дробные чати и всякие NaN undefined и т.д.
      const elem = c === "x" ? piece : (piece & 0x3) | 0x8; // побитово проверяет
